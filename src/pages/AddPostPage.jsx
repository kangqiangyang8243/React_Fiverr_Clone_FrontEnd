...
function AddPostPage() {
  ...
  return (
    <div className="max-w-7xl text-gray-400  mx-auto mt-44 px-7 font-serif flex flex-col gap-5">
      ...
      <form className="flex  flex-col-reverse md:grid grid-cols-2 w-full p-3 gap-6">
        {/* left */}
        <div className="flex flex-col gap-4 flex-grow">
          ...
          <textarea
            ...
            rows={4}
          />
          <button className="py-3 bg-green-400 text-white rounded-lg shadow-md hover:bg-green-500">
            Create
          </button>
        </div>
        {/* right */}
